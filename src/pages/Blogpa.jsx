  ...
  const MobileCategorySelector = () => (
    <div className="lg:hidden mb-8 px-4">
      <select 
        ...
        className="w-full pl-10 pr-4 py-3 bg-white/90 backdrop-blur-sm border-0 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium shadow-lg transition-all duration-300 hover:bg-white"
      >
      ...
      <span className="absolute left-7 top-1/2 transform -translate-y-1/2 text-gray-400">🔍</span>
    </div>
  );
