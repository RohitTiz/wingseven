...
function BlogArticlePage() {
  ...
  return (
    <>
      <AuthSection />
      <div className={`min-h-screen ${darkMode ? 'dark-bg' : 'light-bg'} pt-20 md:pt-24 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Enhanced Back Button */}
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <button 
              onClick={() => navigate('/specializations')}
              className={`flex items-center ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-800'} transition-colors text-sm font-medium px-4 py-2 rounded-lg ${darkMode ? 'hover:bg-gray-700 active:bg-gray-600' : 'hover:bg-blue-50 active:bg-blue-100'}`}
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
              </svg>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button className={`p-1.5 md:p-2 rounded-full ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-100'}`}>
            ...
            <div className="w-full">
              ...
              <div className="mt-10 md:mt-12">
                <div className="flex items-center justify-between mb-4">
                  <h2 className={`text-xl md:text-2xl font-bold ${darkMode ? 'light-text' : 'dark-text'} transition-colors duration-300`}>
                    Popular Articles
                  </h2>
                  <div className="flex space-x-1 md:space-x-2">
                    <button 
                      onClick={scrollLeft}
                      className={`p-1.5 md:p-2 rounded-full ${darkMode ? 'hover:bg-gray-700 text-gray-300' : 'hover:bg-gray-100 text-gray-600'} transition-colors duration-300`}
                ...
                <div 
                  ...
                  className="relative overflow-x-auto scrollbar-hide scroll-smooth pb-3"
                  ...
                  <div className="flex space-x-4 md:space-x-6 w-max">
                    {popularArticles.map(popularArticle => (
                      <div 
                        ...
                        className="cursor-pointer group flex-shrink-0 w-72 md:w-80 transform transition-all duration-300 hover:scale-105"
                        ...
                        <div className={`h-full rounded-xl overflow-hidden ${darkMode ? 'dark-card dark-border' : 'light-card light-border'} shadow-sm hover:shadow-lg transition-all duration-300`}>
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute top-3 right-3 md:top-4 md:right-4">
                              <span className="px-2.5 py-1 md:px-3 md:py-1.5 rounded-full text-xs font-bold uppercase tracking-wide shadow-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                          ...
                          <div className="p-4 md:p-5">
                            {/* Blog Title */}
                            <h4 className={`font-bold text-base md:text-lg mb-1.5 md:mb-2 ${darkMode ? 'light-text' : 'dark-text'} line-clamp-2 transition-colors duration-300 group-hover:text-blue-500`}>
                              {popularArticle.title}
                            </h4>
                            
                            {/* Blog Subtitle/Description */}
                            <p className={`text-xs md:text-sm mb-3 md:mb-4 line-clamp-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'} transition-colors duration-300`}>
                              {popularArticle.subtitle}
                            </p>
                            
                            {/* Blog Stats */}
                            <div className={`flex justify-between items-center mb-3 md:mb-4 text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'} transition-colors duration-300`}>
                            ...
                            {/* Author Section */}
                            <div className={`flex items-center justify-between pt-2 md:pt-3 ${darkMode ? 'border-gray-700' : 'border-gray-100'} border-t transition-colors duration-300`}>
                              <div className="flex items-center">
                                <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center text-white text-xs font-bold mr-2 shadow-md">
