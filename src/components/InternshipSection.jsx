...
const InternshipSection = () => {
  ...
  return (
    <section className={`py-16 px-4 sm:px-6 border-t transition-colors duration-300 ${
      ...
      {/* Decorative elements */}
      <div className={`absolute top-0 left-0 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob ${
        darkMode ? 'bg-blue-900' : 'bg-blue-100'
      }`}></div>
      <div className={`absolute top-0 right-0 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000 ${
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center justify-center">
          ...
          <div className="lg:w-2/5 relative">
            <div className={`relative p-8 rounded-3xl shadow-xl border transition-colors duration-300 ${
              ...
              {/* Curvy line elements */}
              <div className={`absolute -top-4 -left-4 w-24 h-24 rounded-tr-full opacity-20 ${
                darkMode ? 'bg-blue-700' : 'bg-blue-500'
              }`}></div>
              <div className={`absolute -bottom-4 -right-4 w-32 h-32 rounded-tl-full opacity-20 ${
                darkMode ? 'bg-indigo-700' : 'bg-indigo-500'
              }`}></div>
              
              <svg className={`absolute top-8 right-8 w-16 h-16 opacity-30 ${
              ...
              <div className="relative z-10">
                <h2 className={`text-5xl font-extrabold mb-6 leading-tight transition-colors duration-300 ${
                  darkMode ? 'text-gray-100' : 'text-gray-800'
                }`}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className={`font-medium transition-colors duration-300 ${
                      darkMode ? 'text-gray-200' : 'text-gray-700'
                    }`}>Professional mentorship & networking</p>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className={`font-medium transition-colors duration-300 ${
                      darkMode ? 'text-gray-200' : 'text-gray-700'
                    }`}>Certificate & potential job offers</p>
                  </div>
                </div>
                
                <button className="mt-8 px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:from-blue-600 hover:to-indigo-700">
                  Apply Now
                </button>
              </div>
            </div>
