...
const AdminSidebar = () => {
  ...
  // SVG icons to replace react-icons/fi
  const icons = {
    home: (
  ...
  const navItems = [
    { path: "/admin", icon: icons.home, label: "Dashboard" },
    { path: "/admin/courses", icon: icons.book, label: "Courses" },
    { path: "/admin/users", icon: icons.users, label: "Users" },
    { path: "/admin/enrollments", icon: icons.dollarSign, label: "Enrollments" },
    { path: "/admin/analytics", icon: icons.pieChart, label: "Analytics" },
